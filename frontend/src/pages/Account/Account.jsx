...
function Account() {
  ...
  const profileSchema = {
    ...
    '@type': 'ProfilePage',
    name: user?.username || 'Account Dashboard',
  ...
  const breadcrumbSchema = SITE_URL
    ? {
        '@context': 'https://schema.org',
        '@type': 'BreadcrumbList',
        itemListElement: [
    ...
    : null;
  const seoJsonLd = [profileSchema, breadcrumbSchema].filter(Boolean);
  ...
  return (
    <>
      <Seo
        title="Account"
        description="Manage your Sentinel Digest profile, saved stories, social queues, and account preferences."

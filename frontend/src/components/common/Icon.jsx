 ...
 * @param {string} size - Icon size: 'small' (16px), 'medium' (24px), 'large' (32px), or custom size
...
Icon.propTypes = {
  name: PropTypes.oneOf([
    'menu', 'close', 'search', 'facebook', 'twitter', 'x', 'instagram', 
    'youtube', 'linkedin', 'whatsapp', 'arrow-up', 'chevron-down', 
    'plus', 'minus', 'user', 'settings', 'logout', 'heart', 'bookmark',
    'comment', 'share', 'check'
  ]).isRequired,

 ...
 * @param {string} name - Icon name: 'menu', 'close', 'search', 'facebook', 'twitter', 'instagram', 'youtube', 'arrow-up', 'chevron-down', 'plus', 'minus'
 * @param {string} size - Icon size: 'small' (16px), 'medium' (24px), 'large' (32px), or custom size (e.g., '20px')
